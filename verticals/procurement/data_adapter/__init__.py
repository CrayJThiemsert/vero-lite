"""Procurement vertical — synthetic DataAdapter (PLAN-0016 new-vertical scaffold).
...
``register_procurement_adapter`` registers an instance on the process-wide registry
...
def register_procurement_adapter() -> ProcurementSyntheticAdapter:
    """Register a fresh ProcurementSyntheticAdapter on the process-wide registry."""
    adapter = ProcurementSyntheticAdapter()
