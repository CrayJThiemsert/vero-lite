"""BuildingMaterials vertical — synthetic DataAdapter (PLAN-0016 new-vertical scaffold).
...
``register_building_materials_adapter`` registers an instance on the process-wide registry
...
from verticals.building_materials.data_adapter import synthetic
...
class BuildingMaterialsSyntheticAdapter:
    """Deterministic synthetic DataAdapter for the building_materials vertical.
    ...
    vertical_name = "building_materials"
...
def register_building_materials_adapter() -> BuildingMaterialsSyntheticAdapter:
    """Register a fresh BuildingMaterialsSyntheticAdapter on the process-wide registry."""
    adapter = BuildingMaterialsSyntheticAdapter()
