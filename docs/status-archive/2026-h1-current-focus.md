...
> ⚠️ **THIS FILE IS CLOSED TO APPENDS — the live target is [`2026-h1c-current-focus.md`](2026-h1c-current-focus.md)** (Cray-ratified 2026-08-06, session 212; runbook R4's scoped exception). It stopped taking rotations on 2026-07-29 (s189) at 190,527 B, hard against R4's ~192 KB bar, and every Current-Focus rotation since s196 has landed in `h1c`. Do not "restore" appends here.
> **Period covered:** sessions 116 → 128 + a s180–s185 tail (a LEGACY window — this file is no longer the recent one)
> **Sibling chain — for THIS chain the NEWEST LETTER holds the NEWEST content and this base is legacy** (the opposite of the `-status.md` chain; see R4's scoped exception): [`2026-h1b-current-focus.md`](2026-h1b-current-focus.md) (session 25) → [`2026-h1-current-focus.md`](2026-h1-current-focus.md) (this file, legacy) → [`2026-h1c-current-focus.md`](2026-h1c-current-focus.md) (**live append target**; carries s192 onward). This chain is **Current-Focus-only** and is SEPARATE from the rotation archive's `2026-h1b/c/d/e/f/g-status.md` chain — same letter scheme, different corpus, **and now different append rules**.
...
## Rotated this reconcile (session-173, 2026-07-25 — the loop-detect guard pass: #912 age-out/session-boundary + #914 PLAN-0094/Lesson #0033)

Rotated because **R2 requires it**, not as a headroom judgement: with the session-172 and session-173 blocks added, the 4 most-recent sessions are 173 / 172 / 171 / 170, so the session-169 and session-168 blocks fell outside the window.
